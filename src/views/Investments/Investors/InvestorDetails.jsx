...
const InvestorDetails = ({ show, onHide, name, email, phone }) => {
    return (
            ...
            <Modal.Body className="p-0">
                <header className="contact-header">
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            <div className="cp-name text-truncate">{name?.split(" ")[0]} {name?.split(" ")[1]}</div>
                        ...
                        <div className="d-flex flex-xl-nowrap flex-wrap">
                            <div className="contact-info w-xl-35 w-100">
                                ...
                                <Card>
                                    ...
                                    <Card.Body>
                                        <p>Hello there, {name} is a full-stack frontend developer working under pressure is his quality.</p>
                                    </Card.Body>
                                </Card>
                                <div className="separator-full" />
                                <Card>
                                    ...
                                    <ul className="activity-thread">
                                        ...
                                        <li>
                                            <div className="media">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        <div className="activity-text"><span className="text-dark text-capitalize">{name}</span> as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled.</div>
                                                        <div className="activity-time">10.00 pm</div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <ul className="activity-thread">
                                        <li>
                                            <div className="media">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        <div className="activity-text"><span className="text-dark">{name}</span> responded to your appointment schedule question. </div>
                                                        <div className="activity-time">10.00 pm</div>
                                                    </div>
                                                </div>
                                            </div>
