        ...
        <div className="task-info">
            <SimpleBar className="nicescroll-bar">
                ...
                <div className="task-detail-body">
                    ...
                    <HkInlineEdit as="h4" id="editable1" className="fw-bold mb-0" value="Intercom Investment" />
                    <HkInlineEdit as="p" id="editable2" className="mb-0" value="Purchased 1800 shares of Intercom for $2000" />
